		...
		<div class="account-left">
			<div class="account-left-nav">
				...
				<ul class="sub-nav">
					...
					<li><a href="<%=path%>/funds" onclick="return funds(${bank})">提现</a></li>
...
<div class="account-content" style="display: block;">
	<div class="center-view">
		<div class="center-header">
			<img src="<%=path%>/images/d.jpg" width="120" height="120">
		</div>
		...
		<div class="center-user">
			<c:if test="${bank.isEmpty()}">
				<p class="amt color"><span id="usableSum1">0.0</span>元</p>
			</c:if>
			<c:if test="${!bank.isEmpty()}">
			<p class="amt color"><span id="usableSum">${capital.available}</span>元</p>
			</c:if>
			<p class="text">可用余额</p>
			<p class="link">
				<a href="<%=path%>/recharge" class="active">充值</a>
				<a href="<%=path%>/funds" onclick="return funds(${bank})">提现</a>
			</p>
		</div>
