		...
		<div class="account cl">
			...
			<div class="account-left-nav">
				...
				<ul class="sub-nav">
					...
					<li class="active"><a href="<%=path%>/security">安全设置</a></li>
				</ul>
			</div>
		</div>
		<!-- begin -->
...
<div class="popup change-phone">
	...
	<div class="popup-from step1">
		<form action="<%=path %>/UpdatePhoneNumber?uid=${customer.uid}" id="phoneupdate_form"  method="post">
		<div class="label cl">
			<label>原手机号</label>
		...
		<div class="label cl">
			...
			<input type="text" id="newMobliePhone"  name="phone" maxlength="11" placeholder="输入您的新手机号码">
...
<div class="popup change-pwd">
	...
	<a href="javascript:void(0);" style="background-image: url('../images/close.jpg');" class="close"></a>
	<div class="popup-from">
		<form action="<%=path %>/updatePassword" id="update_form"  method="post">
