...
<body bgcolor="#FFFFCC">
	...
	<div class="sub-a-nav">
		...
		<a href="<%=path%>/rechargeJl" id="czjl">充值记录</a>
	</div>
	<em class="em-line"></em>
</div>
<div class="account-content">
	<!-- 充值 -->
	<div class="ipay-pay">
		<p class="tips-title"><b>温馨提示：</b>凡是在此地有银充值未投标的用户，15天以内提现收取本金0.5%，15天以后提现免费 此地有银禁止信用卡套现、虚假交易
等行为,一经发现将予以处罚,包括但不限于：限制收款、冻结账户、永久停止服务,并有可能影响相关信用记录。</p>
	...
	<script type="text/javascript">
		...
		$('#czjl').click(function(){
			window.location.href="<%=path%>/queryBy";
		})
